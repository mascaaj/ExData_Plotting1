#Assignment_1 - Exploratory Data  - PLOT-02
#AJM 06FEB16 V2.1
...
#PLOT TIMESERIES WITH REQUIRED VARIABLES AND PLOT FEATURES
plot(time,Data_2$Global_active_power,xlab="",ylab="Global Active Power (kilowatts)",type="l")
dev.off()
